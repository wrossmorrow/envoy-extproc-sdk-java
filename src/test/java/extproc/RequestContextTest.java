...
class ContextTest {
    ...
    @Test void initializationStartsTimer() {
    ...
    @Test void addHeadersAddsHeaders() {
        RequestContext ctx = new RequestContext();
    ...
    @Test void removeHeaderRemovesHeaders() {
        RequestContext ctx = new RequestContext();
    ...
    @Test void replaceBodyStringTest() {
    ...
    @Test void replaceBodyBytesTest() {
        String replacedBody = "body";
        RequestContext ctx = new RequestContext();
    ...
    @Test void cancellingReturnsImmediateResponse() {
        RequestContext ctx = new RequestContext();
